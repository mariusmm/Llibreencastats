...
Aquest és el repositori del llibre "Curs de programació de sistemes encastats".  El pdf el podeu descarregar [aquí (PDF)](https://github.com/mariusmm/Llibreencastats/releases/download/1.0.7/LlibreEncastats.pdf) o via [leanpub](https://leanpub.com/programacidesistemesencastats/).
